// src/components/whereWindsMeetProductList.jsx
...
// Images
import echo60 from "../../../../assets/images/60-echo.webp";
import echo180 from "../../../../assets/images/180-echo.webp";
import echo300 from "../../../../assets/images/300-echo.webp";
import echo600 from "../../../../assets/images/600-echo.webp";
import echo900 from "../../../../assets/images/900-echo.webp";
import echo1800 from "../../../../assets/images/1800-echo.webp";
import echo3000 from "../../../../assets/images/3000-echo.webp";
import echo6000 from "../../../../assets/images/6000-echo.webp";
import echo12000 from "../../../../assets/images/12000-echo.webp";
import monthly from "../../../../assets/images/wwm-montly.webp";
import elite from "../../../../assets/images/wwm-elite.webp";
import premium from "../../../../assets/images/wwm-premium.webp";
import defaultImg from "../../../../assets/images/60-echo.webp";
...
const WhereWindsMeetProductList = ({
  userId,
  setUserId,
  zoneId,
  setZoneId,
  ...
  const [activeGroup, setActiveGroup] = useState("echo");
  ...
  useEffect(() => {
    const unsub = onSnapshot(
      collection(db, "whereWindsMeetProductList"),
      (snapshot) => {
  ...
  const getProductImage = (item) => {
    if (item.group === "others" && item.label === 'Monly Pass') return monthly;
    if (item.group === "others" && item.label === 'Elite Battle Pass') return elite;
    if (item.group === "others") return premium;
    if (item.group === "echo" && item.diamonds !== undefined) {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <p className="text-xl">Loading Where Winds Meet ...</p>
      </div>
    );
  }
...
export default WhereWindsMeetProductList;