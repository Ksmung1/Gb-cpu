...
const MGlobal = ()=> {
          ...
          return (
                    <div className="p-4 md:px-20 lg:px-40 flex flex-col gap-10">
                             ...
                             <MGlobalProductList  userId={userId} setUserId={setUserId} zoneId={zoneId} setZoneId={setZoneId} username={username} setUsername={setUsername} usernameExists={usernameExists} setUsernameExists={setUsernameExists}/> 
                    </div>
          )
}
