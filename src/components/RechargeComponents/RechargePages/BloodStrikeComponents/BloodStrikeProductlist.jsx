...
import expressPassImg from "../../../../assets/images/bs-elite.webp";
import premiumPassImg from "../../../../assets/images/bs-premium.webp";
...
const BloodStrikeProductList = ({
  ...
  const getProductImage = (item) => {
    if (item.group === "others" && item.label.includes("Elite")) return expressPassImg;
    if (item.group === "others" && item.label.includes("Premium")) return premiumPassImg;
    if (item.group === "bloodstrike" && item.diamonds !== undefined) {
