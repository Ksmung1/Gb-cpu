// src/components/honorKingsProductList.jsx
...
// Images
import tokens80 from "../../../../assets/images/80-tokens.webp";
import tokens240 from "../../../../assets/images/240-tokens.webp";
import tokens400 from "../../../../assets/images/400-tokens.webp";
import tokens560 from "../../../../assets/images/560-tokens.webp";
import tokens830 from "../../../../assets/images/830-tokens.webp";
import tokens1245 from "../../../../assets/images/1245-tokens.webp";
import tokens2508 from "../../../../assets/images/2508-tokens.webp";
import tokens4180 from "../../../../assets/images/4180-tokens.webp";
import tokens8360 from "../../../../assets/images/8360-tokens.webp";
import expressPassImg from "../../../../assets/images/weekly-hok.webp";
import weekly from "../../../../assets/images/weekly2-hok.webp";
import defaultImg from "../../../../assets/images/hok-default.jpeg";
...
const HonorKingsProductList = ({
  ...
  useEffect(() => {
    const unsub = onSnapshot(
      collection(db, "honorKingsProductList"),
      (snapshot) => {
  ...
  const getProductImage = (item) => {
    if (item.group === "others" && item.label === 'Weekly Card Plus') return weekly;
    if (item.group === "others") return expressPassImg;
    if (item.group === "tokens" && item.diamonds !== undefined) {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <p className="text-xl">Loading Honor of Kings ...</p>
      </div>
    );
  }
...
export default HonorKingsProductList;