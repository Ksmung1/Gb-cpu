...
import d from "../../../assets/images/60-echo.webp";
import dd from "../../../assets/images/300-echo.webp";
import specials from "../../../assets/images/weekly-hok.webp";
import twilight from "../../../assets/images/weekly2-hok.webp";
...
const WhereWindsMeetAdmin = () => {
  ...
  const toggleOutOfStock = async (item) => {
    const docRef = doc(db, "whereWindsMeetProductList", item.id);
  ...
  const handleDelete = async (id) => {
    ...
    const success = await deleteItem({
      collectionName: "whereWindsMeetProductList",
      id,
      db,
    });
  ...
  const handleHide = async (id, currentHide) => {
    if (!id) return;
    const docRef = doc(db, "whereWindsMeetProductList", id);
  ...
  const handleSave = async () => {
    ...
    const docRef = doc(db, "whereWindsMeetProductList", selectedItem.id);
  ...
  const filteredItems = items.filter((item) => {
    if (activeGroup === "others") return item.group !== "echo";
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-bold">Where Winds Meet Products</h2>
        <button
...
export default WhereWindsMeetAdmin;